...
FuzzySet* left = new FuzzySet(-90, -30, -30, 0);
FuzzySet* middle = new FuzzySet(-30, -15, 15, 30);
FuzzySet* right = new FuzzySet(0, 30, 30, 90);
FuzzySet* strongright = new FuzzySet(30, 90, 90, 180);
//FuzzySet* strongleft = new FuzzySet(-45, -100, -100, -180);
FuzzySet* strongleft = new FuzzySet(-180, -90, -90, -30);
...
//  FuzzySet* strongrightrud = new FuzzySet(15, 15, 15, 15);
    ...
    FuzzySet* strongleftrud = new FuzzySet(-15, -7.5, -7.5, -3.75);
  FuzzySet* leftrud = new FuzzySet(-7.5, -3.75, -3.75, 0);
  FuzzySet* neutralrud = new FuzzySet(-3.75, 0, 0, 3.75);
  FuzzySet* rightrud = new FuzzySet(0, 3.75, 3.75, 7.5);
  FuzzySet* strongrightrud = new FuzzySet(3.75, 7.5, 7.5, 15);

float mydirection = 30;
// my direction is the difference between desired heading and current heading
float difference = 0;
float myturn = 0;
